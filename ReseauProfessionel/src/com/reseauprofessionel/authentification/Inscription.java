...
public class Inscription extends DashboardActivity {
	...
	private static String url_nouveau_membre = "http://10.0.2.2/friendstracker/controller/Nouveau_Membre.php";
	private static String url_membre_existe = "http://10.0.2.2/friendstracker/controller/Membre_existe.php";
